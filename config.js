...
window.APP_CONFIG = {
    ...
    // Nominal Iuran Kas per bulan (Rp 10.000)
    nominalIuran: 10000,

    // Tautan Penting Kelas (Quick Links, SI-ASRAM, Google Drive & Media Sosial)
    links: {
        ...
        // Kompatibilitas ganda (camelCase & lowercase) agar tidak error saat dipanggil index.html
    ...
    // PIN Pengurus Default & Hak Akses Fitur
    defaultRoles: {
